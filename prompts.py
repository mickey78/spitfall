...
# (Inchangées)
AGE_INSTRUCTIONS = {
    "Enfant": """\n\nIMPORTANT (Public Enfant) : Adapte cette histoire pour un enfant (8-12 ans). Langage simple, pas de violence graphique ou thèmes trop complexes/effrayants. Descriptions plus courtes, directes, positives. Humour léger bienvenu. Focus sur aventure, découverte, exploration, résolution simple.""",
...
Décris ce moment de confusion et d'effroi grandissant. Le contraste entre l'environnement de jeu familier et cette nouvelle réalité troublante. Que ressens-tu face à cette impossibilité de quitter le jeu ? La peur ? La curiosité ? Une étrange excitation ? Fais ressentir l'urgence et le mystère de la situation."""
    },
    {
        ...
        'icon': "☣️",
        'prompt': f"""**Rôle de l'IA :** Tu es le narrateur d'une aventure de survie dans un monde dévasté, des années après 'l'Effondrement'. Ton ton est brut, descriptif, mettant l'accent sur la désolation, le danger constant et la lutte pour les ressources. L'air est lourd de poussière et de silence, brisé seulement par des bruits inquiétants. Date implicite: {current_date}.
